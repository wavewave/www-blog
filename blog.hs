...
main = do 
  ...
  hakyllWith (deploysetup rdir) $ do
    ...
    create "index.html" $ constA mempty
      >>> arr (setField "title" "Ian-Woo Kim's Blog")
...
feedConfiguration =
  FeedConfiguration
    ...
    , feedDescription = "RSS feed for ianwookim.org/blog"
    , feedAuthorName  = "Ian-Woo Kim"
    , feedRoot        = "http://ianwookim.org/blog"
    , feedAuthorEmail = "ianwookim@gmail.com"
    }
